...
(cl:in-package kdlidar_ros_msgs-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kdlidar_ros_msgs-srv:<SaveMap-request> is deprecated: use kdlidar_ros_msgs-srv:SaveMap-request instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <SaveMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kdlidar_ros_msgs-srv:name-val is deprecated.  Use kdlidar_ros_msgs-srv:name instead.")
  (name m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SaveMap-request>)))
  ...
  "kdlidar_ros_msgs/SaveMapRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SaveMap-request)))
  "Returns string type for a service object of type 'SaveMap-request"
  "kdlidar_ros_msgs/SaveMapRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SaveMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SaveMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name kdlidar_ros_msgs-srv:<SaveMap-response> is deprecated: use kdlidar_ros_msgs-srv:SaveMap-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <SaveMap-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader kdlidar_ros_msgs-srv:success-val is deprecated.  Use kdlidar_ros_msgs-srv:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SaveMap-response>)))
  ...
  "kdlidar_ros_msgs/SaveMapResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SaveMap-response)))
  "Returns string type for a service object of type 'SaveMap-response"
  "kdlidar_ros_msgs/SaveMapResponse")
